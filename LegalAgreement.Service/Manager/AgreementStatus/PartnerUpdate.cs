...
{
    public class PartnerUpdate : IDisposable
    {
        ...
        public PartnerUpdate(Put_Request request, IAgreementStatusService agreementStatusService, IConfiguration iconfiguration)
        {
        ...
        private void Send_Agreement_Via_Email()
        {
            try
            {
                _agreementStatusService.Send_Agreement_Via_Email(request.userId, request.statusId);                
            }
            catch (Exception ex)
            {
        ...
        private void Update_Agreement_Status()
        {
            try
            {
                _agreementStatusService.Update_Partner_Agreement_Status(request);
