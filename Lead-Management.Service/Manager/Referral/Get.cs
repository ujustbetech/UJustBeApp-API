...
namespace Lead_Management.Service.Manager.Referral
{
    public class Get : IDisposable
    {
        ...
        public LeadProductInfo _response = null;

        public Get(string referralId, IReferralService referralService)
        {
        ...
        private void Get_Referral_Details()
        {
            try
            {
                _response = _referralService.Get_Product_Service_Details(referralId);
