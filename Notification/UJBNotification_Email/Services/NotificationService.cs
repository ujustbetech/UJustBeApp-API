...
namespace UJBNotification_Email.Services
{
    public class NotificationService
    {
        ...
        {
            var filter = Builders<NotificationQueue>.Filter.In(x => x.status, new[] { "new", "failure" }) & Builders<NotificationQueue>.Filter.Eq(x => x.Type, "Email");
        ...
        internal Lead_Email_Details Get_Lead_Mailing_Details(string dealId)
        {
          ...
          //var  lead = _lead.Find(x => x.Id == dealId).Project(x => new Leads
          //  {
          //      Id = x.Id,
          //    referredBy = x.referredBy,
          //    isForSelf=x.isForSelf,
          //    referredBusinessId=x.referredBusinessId
