...
{
    public class Insert_EnrollPartner:IDisposable
    {
        private Post_EnrollPartner request;
        ...
        public Insert_EnrollPartner(Post_EnrollPartner post_Request, IEnrollPartnerService EnrollPartnerService, IConfiguration iconfiguration
)
        {
        ...
        private void Update_Enrollment()
        {
            try
            {
                _enrollPartnerService.Update_EnrollmentDetails(request);
