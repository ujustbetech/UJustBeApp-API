...
using Promotion.Service.Services.AddPromotionService;
...
using Promotion.Service.Services.GetPromotionService;
...
namespace Promotion.Service
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IAddPromotionService, AddPromotionService>();
