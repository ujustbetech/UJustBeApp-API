...
namespace Partner.Service.Manager.PartnerDetails.PartnerKYC
{
    public class Select : IDisposable
    {
        ...
        public Select(String UserId, IGetPartnerKYC PartnerDetailsService)
        {
            _UserId = UserId;
        ...
        private void GetPartnerProfile()
        {
            try
            {
                _response = _PartnerDetailsService.GetPartnerKYC(_UserId);
